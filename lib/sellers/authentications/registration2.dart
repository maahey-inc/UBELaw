...
import 'package:ubelaw/sellers/authentications/registration3.dart';
        ...
        child: SafeArea(
          child: Column(
            ...
            border: Border(left: BorderSide(color: cardTheme, width: 6.0)),
              ...
              const  SizedBox(height: 10),
              defaultButton(true,"Done",(){ Navigator.push(context, MaterialPageRoute(builder: (c)=>Registration3()));}),
