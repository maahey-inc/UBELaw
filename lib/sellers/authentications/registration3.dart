...
import 'package:ubelaw/sellers/authentications/registration4.dart';
        ...
        child: SafeArea(
          child: Column(
            children:  [
              ...
              const  SizedBox(height: 10),
              Container(width:MediaQuery.of(context).size.width/1.2,child: const Text("Advanced",textAlign: TextAlign.left,style: TextStyle(fontSize: 26,color: Colors.black54,fontWeight: FontWeight.bold,),)),
                ...
                builder: (context) => Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 40),
                       defaultButton(true,"Next",(){ Navigator.push(context, MaterialPageRoute(builder: (c)=>Registration4()));}),
